                ...
                <header id="header" class="navbar">
                    <div class="navbar-toolbar <?php if(isset($page)){ echo 'options-bar';}?>">
                        ...
                        <div class="toolbar-left">
                            <div class="brand-box">
                                <a href="<?= base_url().'home';?>">LeagueX</a>
                                <div class="navbar-title"><?php echo $title?></div>
                            </div>
                        </div>
                        <div class="toolbar-right">
                             <?php if((isset($page)) && ($this->uri->segment(3)== $page)){?>
                            <div class="options-wrap">
                                        <div class="options-btn-bar">
                                            <a href="javascript:void(0);" id="addResultBox" class="options-btn"><i class="material-icons">settings</i></a>
                                        </div>
                                    </div>
                             <?php } ?>
                            <div class="dropdown-wrap">
                                <div class="dropdown custom">
                                    ...
                                    <div class="dropdown-menu notification-container" role="menu">
                                        <div class="dropdown-header ntfcount">
                                    ...
                                    <div class="viewport">
                                        <div class="dropdown-body">
                                            ...
                                            <div id="loadnote">
                                                <div class="loader loadpage"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="dropdown-footer">
                                        <div class="shadow-custom"></div>  
                                        <a href="<?= base_url().'users/edit_settings/userid/'.$this->session->userdata("userid");?>/#tab_notifications" class="animsition-link"><?php echo lang('view_all_notifications');?></a></div>
                                    <?php } ?> 
                                    </div>
                                </div>
                    ...
                    <?php if($this->uri->segment(2)=="edit_settings"){ ?>
                    <div class="nav-tabs-bar">
                        <div class="tab-container withripple active">
                            <a class="withoutripple" href="#profile-settings">Profilo</a>
                        </div>    
                        <div class="tab-container withripple">
                            <a class="withoutripple" href="#notifications" id="note-tab"><input type="hidden" value="<?php echo $this->session->userdata('userid')?>" name="user_id" /><?php echo lang('esett_tab_notifications');?></a>
                        </div>    
                    </div>
                    <?php } ?>
