  ...
  function(_jquery) {
    ...
    var asSpinner = function() {
      ...
      _createClass(asSpinner, [{
        key: 'init',
        value: function init() {
          this.$control = (0, _jquery2.default)('<div class="' + this.namespace + '-control"><span class="material-icons up">keyboard_arrow_up</span><span class="material-icons down">keyboard_arrow_down</span></div>');
          this.$wrap = this.$element.wrap('<div tabindex="0" class="' + this.classes.wrap + '"></div>').parent();
          this.$down = this.$control.find('.material-icons.down');
          this.$up = this.$control.find('.material-icons.up');
