(function ($) {
    ...
    FormValidation.I18n = $.extend(true, FormValidation.I18n, {
        'it_IT': {
            base64: {
                'default': 'Inserire un valore codificato in Base 64'
            },
            between: {
                'default': 'Inserire un valore tra %s e %s',
            ...
            callback: {
                'default': 'Inserire un valore valido'
            },
            choice: {
            ...
            date: {
                'default': 'Inserire una data valida',
            ...
            emailAddress: {
                'default': 'Inserire un indirizzo email valido'
            },
            file: {
            ...
            notEmpty: {
                'default': 'Non lasciare il campo vuoto'
            },
            numeric: {
            ...
            stringLength: {
                ...
                between: 'Inserire un numero di caratteri compreso tra  %s e %s'
            },
            uri: {
